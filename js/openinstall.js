OpenInstall = function(e, n, t) {
    function r(n) {
        ...
        var i = n.indexOf("?"); - 1 == i && (n = t, i = n.indexOf("?"));
        for (var o = -1 == i ? "": n.substring(i + 1).replace(/\+/g, "%20"), a = o.split("&"), c = {},
        u = 0; u < a.length; u++) {
            var l = a[u].split("="),
            s = decodeURIComponent(l[0] || ""),
            d = decodeURIComponent(l[1] || "");
            s && d && (void 0 === c[s] ? c[s] = d: "object" == typeof c[s] ? c[s].push(d) : c[s] = [c[s], d])
        }
        return c
    }
    function i(e) {
    ...
    function l(n) {
        R(function(t) {
            ...
            for (var c = 0,
            t = t || [], l = t.length; c < l; c++) t[c] = C(t[c] || "");
            n({
                sw: C("" + (r || 0)),
                sh: C("" + (i || 0)),
                sp: o,
    ...
    function s(t, r, i) {
        ...
        for (var v, g, m = !1,
        b = r ? r + ((new Date).getTime() + (i || 1)) + "-": null, h = 0; h < p.length; h++) {
            try {
    ...
    R = function() {
        ...
        10);
        try { ! v && (o = e.RTCPeerConnection || e.mozRTCPeerConnection || e.webkitRTCPeerConnection) ? (c = new o({
                iceServers: []
            },
            {
                optional: [{
    ...
    I.parseUrlParams = r,
    I.docReady = g,
    I.server = "https://s.openinstall.io",
